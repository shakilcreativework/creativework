...
const Navbar = () => {
    ...
    return (
        <div className="bg-[#faf8f5cc] sticky py-4 ">
            <nav className="max-w-350 mx-auto px-4 lg:px-0 flex justify-between items-center w-full z-50 ">
                ...
                {/* small devices */}
                <ul
                    className={`absolute md:hidden w-full flex flex-col bg-[#faf8f5cc] gap-6 items-center left-0 py-6 transform transition-all duration-300 ease-in-out
