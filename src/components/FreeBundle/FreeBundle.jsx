        ...
        <div className="py-20">
            <Container>
                <div className="bg-[#0c121a] rounded-2xl text-white plus-jakarta grid grid-cols-1 lg:grid-cols-2 overflow-hidden">
                    <div className=" p-6 lg:p-16 xl:p-20 md:pr-0 space-y-5">
                        <span className="py-1.5 px-4 rounded-full text-xs font-bold uppercase text-orange-500 bg-orange-100">
                            free bundle
                        </span>
                        <h1 className="flex gap-2 lg:gap-2 xl:gap-1 text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold lg:font-extrabold mt-5"> <img className="w-16 h-16 lg:w-20 lg:h-20 xl:w-24 xl:h-24" src="https://i.ibb.co.com/Hpf5bLht/bonfire.png" alt="" /> Get 50+ Free <br /> Animal Silhouettes</h1>
