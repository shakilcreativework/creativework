        ...
        <div className='py-10 md:py-16 lg:py-20'>
            <Container>
                <div>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-5 mt-10'>
                        <div className='group shadow-xs hover:shadow-sm bg-white p-4 md:-p-5 lg:p-6 rounded-lg space-y-1'>
                            <div className='w-14 h-14 bg-[#fff1ee] text-[#E07A5F] flex justify-center items-center rounded-full mb-4'>
                                <IoMdCheckmarkCircleOutline className='text-2xl' />
                            </div>
                            <h3 className='font-extrabold text-sm md:text-base plus-jakarta'>Commercial Use Ready</h3>
                        ...
                        <div className='group shadow-xs hover:shadow-sm bg-white p-4 md:-p-5 lg:p-6 rounded-lg space-y-1'>
                            ...
                            <h3 className='font-extrabold text-sm md:text-base plus-jakarta'>High-Quality Vector Files</h3>
                        ...
                        <div className='group shadow-xs hover:shadow-sm bg-white p-4 md:-p-5 lg:p-6 rounded-lg space-y-1'>
                            ...
                            <h3 className='font-extrabold text-sm md:text-base plus-jakarta'>Instant Download</h3>
                        ...
                        <div className='group shadow-xs hover:shadow-sm bg-white p-4 md:-p-5 lg:p-6 rounded-lg space-y-1'>
                            ...
                            <h3 className='font-extrabold text-sm md:text-base plus-jakarta'>Free + Premium Options</h3>
