            ...
            <Container>
                <div className='text-center'>
                    <div className='space-y-3'>
                        ...
                        <h1 className=" mt-4 flex flex-col sm:flex-row gap-3 justify-center items-center text-2xl md:text-4xl lg:text-5xl text-[#1F1B16] plus-jakarta font-extrabold">
